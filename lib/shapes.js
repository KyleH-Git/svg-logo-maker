...
class Shape {
    ...
    name(nameColor, logoName){
        const nameStr = `<text x="150" y="125" font-size="60" text-anchor="middle" fill="${nameColor}">${logoName}</text>`;
        return nameStr;
    }
}
    ...
    render(){
        ...
        const svgStr = `
            <svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
                ...
                ${this.name(this.nameColor, this.logoName)}
            </svg>
            `;
        return svgStr;
    }
