...
describe('Square', () => {
    describe('render()', () => {
        it('Should return square SVG when called with Square constructor', () => {
            ...
            const expected = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="200" x="50" y="0" fill="black" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="white">XYZ</text></svg>`
            //assert - 
            expect(svg).toEqual(expected);
        })
    })
